public class Java02 {
    public static void main(String[] args) {
        ...
        */
        ...
        // 4. long : -9백경 ~ 9백경
        // 세부범위 : -9,223,372,036,854,775,808 ~ 9,223,372,036,854,775,807
        // 특이사항 -> 범위안의 숫자일 지라도 끝에 L
        // 표시를 하지 않으면 int형 상수로 처리한다!
        // int범위를 벗어나는 에러가 발생한다!
        // 끝에 L자를 써줘야 한다(소문자l도 가능 but 헷갈림)
        long numLong = 9223372036854775807L;
        System.out.println("long: "+numLong);

        // 5. float : 소수 자릿수 6 ~ 7
        // 특이사항 : 숫자데이터를 끝에 F로 처리해야 같은형임!
        // 소수점 아래 넘치는 경우 7째 자리에서 반올림함!
        float numFloat = 5.12345678F; // 결과: 5.1234567
        System.out.println("float: "+numFloat);

        // 6. double : 소수 자릿수 15
        // 특이사항 : 숫자데이터 끝에 D로 처리해야 같은형임!
        // float이나 double은 근사값이므로 끝자리수가 달라질 수 있음!
        double numDouble = 7.123456789123D;
