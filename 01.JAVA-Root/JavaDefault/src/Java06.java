...
public class Java06 {
    public static void main(String[] args) {
        ...
        System.out.println("9000원짜리 점심을 6명이 먹었다. 얼마를 내야하나? "+j06.myThrid(9000, 6)+"원");

        // 나의 네번째 메서드 : 이달의 표어
        System.out.println("이달의 표어: "+j06.makeTitle(1000, "소시지를 드립니다!"));
    ...
    // 식사비 계산 : pay는 가격, people는 사람수
    public int myThrid(int pay, int people){
        return pay * people;
    } ///// myThird 메서드 /////
